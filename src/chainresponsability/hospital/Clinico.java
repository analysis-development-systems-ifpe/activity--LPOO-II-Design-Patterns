...
public class Clinico extends Medico {
	...
	public  void atendePaciente( Paciente paciente){
		if(paciente.getEspecialistaMedicoEnum().equals(EspecialistaMedicoEnum.CLINICO) && this.ocupado == false){
			  synchronized(this){
	...
	public  void gerarListaPacienteAtendidos(){
	 ...
	 public String toString(){
			return "ID = "+ this.id + "Especialidade = " + EspecialistaMedicoEnum.CLINICO;
		}
