...
public class Ginecologista extends Medico {
	...
	public  void atendePaciente( Paciente paciente){
		if(paciente.getEspecialistaMedicoEnum().equals(EspecialistaMedicoEnum.GINECOLOGISTA) && this.ocupado == false){
			  synchronized(this){
	...
	public  void gerarListaPacienteAtendidos(){
	 ...
	 public String toString(){
			return "ID = "+ this.id + "Especialidade = " + EspecialistaMedicoEnum.GINECOLOGISTA;
		}
