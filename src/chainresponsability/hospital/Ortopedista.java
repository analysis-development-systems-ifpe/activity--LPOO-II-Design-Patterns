...
public class Ortopedista extends Medico {
	...
	public  void atendePaciente( Paciente paciente){
		if(paciente.getEspecialistaMedicoEnum().equals(EspecialistaMedicoEnum.ORTOPEDISTA) && this.ocupado == false){
			  synchronized(this){
	...
	public  void gerarListaPacienteAtendidos(){
	 ...
	 public String toString(){
			return "ID = "+ this.id + "Especialidade = " + EspecialistaMedicoEnum.ORTOPEDISTA;
		}
